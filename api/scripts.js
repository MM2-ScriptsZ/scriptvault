...
module.exports = async (req, res) => {
  ...
  if (req.method === 'GET') {
    ...
    let query = supabase.from('scripts').select('id,title,game,category,status,description,views,date', { count: 'exact' });
  ...
  if (req.method === 'POST') {
    ...
    const { title, game, category, status, description, script } = req.body;
